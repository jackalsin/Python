...
def nearestKaprekarNumber(n):
    ...
    while True:
        if isKaprekarNumber(guess):
            return guess
        elif isKaprekarNumber(guess-count):
            return (guess-count) 
        elif isKaprekarNumber(guess+count):
            return (guess+count)
        count+=1

# print(nearestKaprekarNumber(2728))
...
def integral(f, a, b, N): 
    ...
    area=0
    count=0
    while(not almostEqual(xLeft,b)):
        area+=Area(f,xLeft,xRight)
        xLeft+=bias
        xRight+=bias
        count+=1
    # print(count)
...
def testNearestKaprekarNumber():
    ...
    # assert(nearestKaprekarNumber(3) == 3967)
    # assert(nearestKaprekarNumber(4) == 16127)
    # assert(nearestKaprekarNumber(5) == 1046527)
    # assert(nearestKaprekarNumber(6) == 16769023)
    print("Passed. (Add more tests to be more sure!)")
