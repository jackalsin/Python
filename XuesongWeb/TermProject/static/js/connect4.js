...
function Game() {
    ...
    this.win = function (winner) {
        ...
        function recordData() {
            var winParanet = document.getElementById("winParent");
            var input = document.createElement("input");
            winParanet.appendChild(input);
            ...
            button.setAttribute("id", "usernameInputButton");
            button.setAttribute("class", "btn btn-danger");
            button.setAttribute("type", "button");
            button.setAttribute("onclick", "sendRecord()");
            button.innerHTML ="Submit";
            winParanet.appendChild(button);
    ...
    sendRecord = function () {
        ...
        if (username) {
            ...
            xhttp.open("GET", "/saveRecord/?username=" + username + "&moves=" + moveFinish, true);
            xhttp.send();


            var winParanet = document.getElementById("winParent");
            var input = document.getElementById("input");
            winParanet.removeChild(input);
            var button = document.getElementById("button");
            winParanet.removeChild(button);
        }
        // delete the input and button.
    };

    function showWinningMsg(rect, context, msg) {
        context.save();
        $("#winMsgToDisplay").text(msg);
        context.restore()
    }
